...
private ["_track_dist","_poz_spark","_Mark","_spark_pos","_spark_obj"];

if (!isServer) exitWith {};

params ["_spark_pos","_track_dist","_damage_range","_EMP_enabled","_Ai_attack","_Twins_will_stop","_Twins_invincible","_Give_Light","_Twins_Bool"];

//creates either variant of twins
if (_Twins_Bool) then {
//Creates Twins (A)
_spark_obj = createVehicle ["Land_HighVoltageTower_largeCorner_F", _spark_pos, [], 0, "CAN_COLLIDE"];
} else {
//Creates Twins (B)
...
//Creates a invisible Helipad under the tower so death animation doesn't start halfway up the tower
_Mark = createVehicle ["Sign_Sphere10cm_F", [0,0,0], [], 0, "CAN_COLLIDE"];
[_Mark, true] remoteExec ["hideObjectGlobal",0,true];
_Mark attachTo [_spark_obj, [0, 0, -20]];
...
[_spark_obj, _track_dist, _damage_range, _heart_twin, _EMP_enabled, _Mark, _Ai_attack, _Give_Light, _Twins_invincible] spawn {
private ["_twinslight","_twinslight_alt","_tgt_1","_tgt_2"];
//waitUntil{!isNil "vizibil"};

params ["_spark_move","_track_dist","_dam_range","_heart_twin","_EMP_enabled","_Mark","_Ai_attack","_Give_Light","_Twins_invincible"];
...
if (_Give_Light) then {
	...
	if (_Twins_invincible)  then{
	_twinslight = createVehicle ["Reflector_Cone_01_narrow_blue_F", [0,0,0], [], 0, "NONE"];
...
//_Zap_1 = createVehicle ["Land_HelipadEmpty_F", [0,0,0], [], 0, "CAN_COLLIDE"];
//_Zap_1 attachTo [_spark_move, [0, 5, -20]];
...
/////////////////////////////////////
//stuff that happens after it dies
/////////////////////////////////////
...
//deletes invisible targets if they were previously activated by zeus
if (_Ai_attack) then {
...
[[_Mark],"NJ_Twins\Teleport_Lightning_Twins.sqf"] remoteExec ["execVM"];
uiSleep 8;
