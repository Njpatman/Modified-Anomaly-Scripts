...
_Screamer_object = createVehicle ["Land_AncientStatue_01_F", [0,0,0], [], 0, "CAN_COLLIDE"];
...
while {alive _Screamer_entity} do
{
	...
	if (_Screamer_entity nearEntities [["CAManBase","Tank","Car","Armored","Air"],_Activation_Range]) then {
